...
function Chat({ rights }) {
  ...
  useEffect(() => {
    const greetings = {
      lawyer:  "שלום, אני כאן בכובע עורך הדין שלך ⚖️\n\nאני אעזור לך להבין מה מגיע לך מבחינה משפטית — ועדות, תביעות, זכויות שלא מומשו. ספר לי: מה המצב שלך? כמה אחוזי נכות הוכרו לך, ומה הביאך לכאן?",
      social:  "שלום, אני כאן בתפקיד העו\"ס שלך 🤝\n\nאני אלווה אותך דרך המערכת — ניירת, פניות לגופים, שירותים שאולי לא ידעת עליהם. ספר לי קצת על עצמך — איפה אתה נמצא ברגע זה, ומה הכי לוחץ עליך?",
      psycho:  "שלום, אני שמח שבאת לדבר 💙\n\nהמקום הזה הוא שלך — אפשר לשתף מה שנוח, בקצב שנוח. לפעמים החלק הכי קשה הוא לדעת מאיפה מתחילים, אז בוא נתחיל מזה: איך אתה מרגיש היום, ברמה הכי בסיסית?",
    };
