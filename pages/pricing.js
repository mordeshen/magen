...
const PLAN_FEATURES = {
  free: [
    "שיחה עם 3 מומחים — עו\"ד, עו\"ס, פסיכולוג",
    "בסיס ידע זכויות מלא",
    "זיכרון שיחות",
    "50K טוקנים ליום",
  ],
  ...
  premium: [
    "הכל בחודשי, ועוד:",
    "Claude Opus — המודל החזק ביותר",
    "תשובות ארוכות במיוחד",
    "Agent — ביצוע פעולות אוטומטי",
    "עדיפות בתור",
  ],
};
      ...
      <div className="pricing-page" dir="rtl">
        ...
        <section className="pricing-transparency" id="transparency">
          <div className="transparency-box">
            ...
            <p>כל תשובה עוברת דרך שרתי AI שעולים כסף אמיתי.<br />אין פה רווחים — הכל חוזר לתחזוקה, שיפור, וקידום מול משרד הביטחון.<br />המסלול החינמי פתוח תמיד.<br />התשלום הוא מה שמאפשר למגן להמשיך לפעול.</p>
          </div>
        </section>
        ...
        <section className="pricing-faq">
          ...
          <div className="faq-grid">
            ...
            <div className="faq-item">
              ...
              <p>המסלולים הגבוהים משתמשים ב-Claude Opus — מודל AI חזק יותר שנותן תשובות מעמיקות ומדויקות יותר.</p>
            </div>
          </div>
        </section>
