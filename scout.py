...
חשוב מאוד לגבי link:
- חפש את הלינק הספציפי לעמוד האירוע עצמו, לא לדף הבית של הארגון.
- חפש באתרי בתי הלוחם: bh-tla.inz.org.il, bh-j.inz.org.il, bh-h.inz.org.il ותחפש דפי אירועים/לוח שנה/פעילויות.
- אם אין לינק ישיר לאירוע עצמו — שים null. עדיף null מאשר לינק לדף הבית.
